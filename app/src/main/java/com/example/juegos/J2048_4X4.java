...
public class J2048_4X4 extends AppCompatActivity {


    private TextView[][] arrayJuego = new TextView[4][4];
    private int[][]   valores = new int[4][4];
    private Button newGame;
    private TextView puntos;
    private Button atras;
    private int puntuacion = 0;
    private String[][] arrayRespaldo = new String[4][4];


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_j20484_x4);


        //Detecta los movimientos que se hagan dentro del gridbagLayout
        findViewById(R.id.gridLayout).setOnTouchListener(new OnSwipeTouchListener(J2048_4X4.this) {
        ...
        newGame.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),J2048_4X4.class);
    ...
    public void asignarNumero(){
        ...
        if (hay_posiciones_vacias == true){
            ...
            while(sin_asignar == true){
                int columna_rand = rand.nextInt(4);
                int fila_rand = rand.nextInt(4);
